...
@Component({
    template: `
        <div class="wrapper main">
            ...
            <p>
                DeepKit UG (haftungsbeschränkt)<br/>
                Geschäftsführer: Marc J. Schmidt<br/>
                Meridianstrasse 16<br/>
            ...
            <p>We make every effort to keep the information on our web site current, but accept no liability whatsoever
            ...
            <p>Please be aware that there are inherent security risks in transmitting data, such as e-mails, via the
                ...
                other similar advertising materials.</p>
            <h2>Privacy Statement for the Use of Google Analytics</h2>
            <p>This website uses Google Analytics, a web analytics service provided by Google Inc. ("Google"). Google
                ...
                other parties to the Agreement on the European Economic Area before.</p>
            <p>Only in exceptional cases the full IP address is sent to a Google server in the USA where it shortened.
                ...
                IP address will not be merged with other data from Google.</p>
            <p>You may refuse the use of cookies by selecting the appropriate settings on your browser, we would point
            ...
            <h2>Privacy Statement for the Tawk.to, Live Chat Software</h2>
            <p>This website uses tawk.to, a live chat solution provided by tawk.to Ltd. Tawk.to uses cookies to help us
